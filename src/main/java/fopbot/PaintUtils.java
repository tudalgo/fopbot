...
public class PaintUtils {
     ...
     */
    public static Point getBoardSize(final @NotNull KarelWorld world) {
     ...
     */
    public static @NotNull BufferedImage[] loadScaleRotateFieldImage(
    ...
    public static BufferedImage loadFieldImage(
        final @NotNull InputStream inputImage,
     ...
     */
    public static @NotNull BufferedImage scaleAndRotateImageWithGPU(
     ...
     */
    public static Rectangle getFieldBounds(final @NotNull FieldEntity fe, final @NotNull KarelWorld world) {
     ...
     */
    public static @NotNull Point getUpperLeftCornerInField(
        final @NotNull FieldEntity fe,
     ...
     */
    public static @NotNull Point getMouseTilePosition(
        final @NotNull GuiPanel panel,
        final @NotNull Point mousePosition
    ) {
     ...
     */
    public static @NotNull AffineTransform getPanelWorldTransform(final @NotNull GuiPanel panel) {
     ...
     * @return the point2D
     */
    public static @NotNull Point2D toPoint2D(final @NotNull Point point) {
     ...
     * @return the transform
     */
    public static @NotNull AffineTransform getPanelTransform(final @NotNull GuiPanel panel) {
     ...
     * @return the transform
     */
    public static @NotNull AffineTransform getWorldTransform(final @NotNull KarelWorld world) {
        final ColorProfile cp = world.getColorProfile();
     ...
     */
    public static @NotNull BufferedImage scaleImageWithGPU(
        final @NotNull BufferedImage image,
        final int width,
        final int height
    ) {
