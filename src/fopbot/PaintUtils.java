...
public class PaintUtils {
	...
	protected static Image[] loadScaleRotateFieldImage(InputStream inputImage, int upRotationOffset)
		...
		for (int i = 0; i < 4; i++) {
			...
			af.rotate(Math.toRadians(degrees), originalBufferedImage.getWidth() / 2,
					originalBufferedImage.getHeight() / 2);
	...
	/**
	 * Returns the upper left corner coordinates of a specific field (the fe is
	 * standing on)
	 * 
	 * @param fe
	 * @param worldHeight
